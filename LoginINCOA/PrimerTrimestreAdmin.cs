...
{
    public partial class PrimerTrimestreAdmin : Form
    {
        ...
        public PrimerTrimestreAdmin()
        {
            ...
            BotonesRedondeados.BordesRedondeados(btnModificarE); //BOTON ACTUALIZAR TABLA
        ...
        {
            Form LlamarFormularioModificarE = new ModificarENotasTrim1(); // CREANDO NUEVO OBJETO DE TIPO FORMULARIO
