...
{
    public partial class SegundoTrimestreAdmin : Form
    {
        ...
        {
            Form LlamarFormularioModificarE = new ModificarENotasTrim2(); // CREANDO NUEVO OBJETO DE TIPO FORMULARIO
