...
namespace LoginINCOA
{
    ...
    public partial class AgregarNotasTrim2 : Form
    {
        public int contador;
        ...
        private void btnRegistroNota_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlCommand Comunicacion = new SqlCommand("SELECT cod_asignatura, cod_alumno FROM Trimestre2 WHERE cod_asignatura = @cod_asignatura AND cod_alumno = @cod_alumno", Controlador.Conexiones());
                    ...
                    {
                        string query = "INSERT INTO Trimestre2 (cod_alumno, cod_asignatura, Act1, Act2, Exam, promedio2) VALUES (@cod_alumno, @cod_asignatura, @Act1, @Act2, @Exam, @promedio2)";
        ...
        private void cbCodAlumno_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DetallesTrim1Sistema.DataSource = integracion.SelectDataTable("SELECT * FROM Trimestre2 WHERE cod_alumno LIKE ('" + cbCodAlumno.Text + "%')");
        }
    }
}
/**
