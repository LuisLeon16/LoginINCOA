...
{
    public partial class MensajeErrorDuplicados : Form
    {
        ...
        // POSICION PANTALLA PERSONALIZADO
        private void MensajeErrorDuplicados_Load(object sender, EventArgs e)
        {
