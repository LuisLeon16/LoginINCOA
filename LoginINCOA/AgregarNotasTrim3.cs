...
namespace LoginINCOA
{
    ...
    public partial class AgregarNotasTrim3 : Form
    {
        public int contador;
        ...
        private void btnRegistroNota_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlCommand Comunicacion = new SqlCommand("SELECT cod_asignatura, cod_alumno FROM Trimestre3 WHERE cod_asignatura = @cod_asignatura AND cod_alumno = @cod_alumno", Controlador.Conexiones());
                    ...
                    {
                        string query = "INSERT INTO Trimestre3 (cod_alumno, cod_asignatura, Act1, Act2, Exam, promedio3) VALUES (@cod_alumno, @cod_asignatura, @Act1, @Act2, @Exam, @promedio3)";
