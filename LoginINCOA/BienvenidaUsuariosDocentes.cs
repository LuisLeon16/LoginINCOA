...
{
    public partial class BienvenidaUsuariosDocentes : Form
    {
        public BienvenidaUsuariosDocentes()
        {
            InitializeComponent();
        ...
        private void BienvenidaUsuariosDocentes_Load(object sender, EventArgs e)
        {
