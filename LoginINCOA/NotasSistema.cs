...
{
    public partial class NotasSistema : Form
    {
        ...
        {
            MostrarFormularios(new PrimerTrimestre());

            //    --> ESTILOS HOVER PARA BOTONES Y TEXTO ACTIVO / INACTIVO

            btnPrimerTrimestre.BackColor = Color.FromArgb (157, 28, 32);  // ESTADO ACTIVO   
            btnPrimerTrimestre.ForeColor = Color.WhiteSmoke; // ESTADO ACTIVO 

            // ESTADO INACTIVO ↓ {TODOS} -> BOTONES

            btnSegundoTrimestre.BackColor = Color.DarkGray;
            btnSegundoTrimestre.ForeColor = Color.White;
            btnTercerTrimestre.BackColor = Color.DarkGray;
            btnTercerTrimestre.ForeColor = Color.White;
            btnResumen.BackColor = Color.DarkGray;
        ...
        {
            MostrarFormularios(new SegundoTrimestre());

            //    --> ESTILOS HOVER PARA BOTONES Y TEXTO ACTIVO / INACTIVO

            btnSegundoTrimestre.BackColor = Color.FromArgb(157, 28, 32);  // ESTADO ACTIVO   
            btnSegundoTrimestre.ForeColor = Color.WhiteSmoke; // ESTADO ACTIVO 

            // ESTADO INACTIVO ↓ {TODOS} -> BOTONES

            btnPrimerTrimestre.BackColor = Color.DarkGray;
        ...
        {
            MostrarFormularios(new TercerTrimestre());

            //    --> ESTILOS HOVER PARA BOTONES Y TEXTO ACTIVO / INACTIVO

            btnTercerTrimestre.BackColor = Color.FromArgb(157, 28, 32);  // ESTADO ACTIVO   
        ...
        {
            MostrarFormularios(new ResumenTrimestres());

            //    --> ESTILOS HOVER PARA BOTONES Y TEXTO ACTIVO / INACTIVO

            btnResumen.BackColor = Color.FromArgb(157, 28, 32);  // ESTADO ACTIVO   
