...
{
    public partial class MensajeErrorEliminarDatos : Form
    {
        ...
        public MensajeErrorEliminarDatos()
        {
            InitializeComponent();
            Opacity = .95;
        ...
        // POSICION VENTANA PANTALLA PERSONALIZADO
        private void MensajeErrorEliminarDatos_Load(object sender, EventArgs e)
        {
